...
/* <<<                
// === */
    public ItemStack slotClick(int a, int b, boolean flag, EntityPlayer entityplayer) {
  		ItemStack result = super.slotClick(a, b, flag, entityplayer);
        World world = worldObj;
        int i = posX;
        int j = posY;
        int k = posZ;
...
class SlotCraftingMultiple extends Slot
{
    ...
    public void onPickupFromSlot(ItemStack itemstack)
    {
    	...
    	// === */
        field_25015_e.addStat(StatList.objectCraftStats[itemstack.itemID], total);
        if(itemstack.itemID == Block.workbench.blockID)
        {
        	// build workbench
