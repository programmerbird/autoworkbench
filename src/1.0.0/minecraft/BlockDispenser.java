...
// === */
        ...
        int i2 = world.getBlockId(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ);
        int j2 = world.getBlockMetadata(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ);
// >>>            
        TileEntityDispenser tileentitydispenser = (TileEntityDispenser)world.getBlockTileEntity(i, j, k);
        if(tileentitydispenser != null){
    /* <<<                
    // === */
            if((i2 == 9 || i2 == 11 || i2 == 8 || i2 == 10) && j2 == 0)
            {
                for(int k1 = 0; k1 < tileentitydispenser.getSizeInventory(); k1++)
                {
                    ...
                    {
                        world.setBlockAndMetadataWithNotify(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, 0, 0);
    ...
    // === Dispensers+ */
                ...
                if(itemstack.itemID == 46 || itemstack.itemID == 326 || itemstack.itemID == 327)
                {
                    ...
                    if(i2 == 0 || i2 == 8 || i2 == 9 || i2 == 10 || i2 == 11)
                    {
                        ...
                        world.setBlockAndMetadataWithNotify(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, byte0, 0);
