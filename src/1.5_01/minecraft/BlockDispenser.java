...
// === */
        ...
        int i1 = world.getBlockId(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z);
        int j1 = world.getBlockMetadata(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z);
// >>>            
        TileEntityDispenser tileentitydispenser = (TileEntityDispenser)world.getBlockTileEntity(i, j, k);
/* <<<                
// === */
...
// === */
            ...
            if(hasModLoader) {
            	try{
		        	...
		        	Class parameters[] = {World.class, double.class, double.class, double.class, float.class, float.class, ItemStack.class};
		        	Method method = modLoaderClass.getMethod("DispenseEntity", parameters);
				    Object arguments[] = {world, d, d1, d2, f, f1, itemstack};
