...
/* <<<                
// === */
    public ItemStack func_27280_a(int a, int b, boolean flag, EntityPlayer entityplayer) {
  		ItemStack result = super.func_27280_a(a, b, flag, entityplayer);
        World world = field_20133_c;
        int i = field_20132_h;
        int j = field_20131_i;
        int k = field_20130_j;
...
class SlotCraftingMultiple extends Slot
{
    ...
    public void onPickupFromSlot(ItemStack itemstack)
    {
    	...
    	// === */
        field_25015_e.addStat(StatList.field_25158_z[itemstack.itemID], total);
        if(itemstack.itemID == Block.workbench.blockID)
        {
        	// build workbench
            field_25015_e.addStat(AchievementList.buildWorkBench, total);
        }
    	// >>>            
